...
public class Desert : Area
{
    ...
    {
        "Stage4-1", "Stage4-2", "Stage4-3", "Stage4-4", "Stage4-5"
    };
    ...
    protected override void LateStart()
    {
        ...
        else if (DataSystem.HasData("Puzzle", puzzles[2]) && !DataSystem.HasData("Story", "Desert.Story.00"))
        {
            DataSystem.SetData("Story", "Desert.Story.00", 1);
            ActionSystem.instance.AddAction(ActionSystem.Action.ActionType.Talk, talks[1]);
        }
        else if (DataSystem.HasData("Puzzle", puzzles[4]) && !DataSystem.HasData("Story", "Desert.Story.01"))
        {
            DataSystem.SetData("Story", "Desert.Story.01", 1);
